...
int8_t mqtt_transport_connect(uint8_t sock, uint8_t ssl_flag, uint8_t *recv_buf, uint32_t recv_buf_len, uint8_t *domain, uint32_t port, tlsContext_t *tls_context, BackoffAlgorithmContext_t *backoff_context, MQTTEventCallback_t userCallback) {
